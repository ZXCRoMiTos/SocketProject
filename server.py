    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                logger.info(f'Ошибка работы с сокетами: {err}')
...
def main():
    ...
    main_window.active_clients_table.setModel(create_gui_model(database))
    ...
    main_window.history_btn.triggered.connect(show_statistics)
